(function () {
    const reviewsData = [
        ...
        { name: "Дмитрий М.", text: "Надёжно и современно. Отдельное спасибо за flexbox вёрстку, всё ровно.", date: "19.12.2024" }, // Дмитрий М. ... врет проще говоря
        { name: "Татьяна Р.", text: "Очень душевные комментарии. Приятно видеть такой подход к отзывам, не скучно.", date: "05.11.2024" },
        { name: "Алексей Н.", text: "Удобная навигация между отзывами, ползунок медленно листает — как моя кукуха.", date: "22.10.2024" },
